...
namespace Nest
{
		...
		, IBoolQuery where T : class
	{
		...
		public BoolQueryDescriptor<T> Must(params Func<QueryContainerDescriptor<T>, QueryContainer>[] queries) =>
			Assign(a => a.Must = queries.Select(q => q?.InvokeQuery(new QueryContainerDescriptor<T>())).Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
		...
		public BoolQueryDescriptor<T> Must(params QueryContainer[] queries) =>
			Assign(a => a.Must = queries.Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
		...
		public BoolQueryDescriptor<T> MustNot(params Func<QueryContainerDescriptor<T>, QueryContainer>[] queries) =>
			Assign(a => a.MustNot = queries.Select(q => q?.InvokeQuery(new QueryContainerDescriptor<T>())).Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
		...
		public BoolQueryDescriptor<T> MustNot(params QueryContainer[] queries) =>
			Assign(a => a.MustNot = queries.Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
		...
		public BoolQueryDescriptor<T> Should(params Func<QueryContainerDescriptor<T>, QueryContainer>[] queries) =>
			Assign(a => a.Should = queries.Select(q => q?.InvokeQuery(new QueryContainerDescriptor<T>())).Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
		...
		public BoolQueryDescriptor<T> Should(params QueryContainer[] queries) =>
			Assign(a => a.Should = queries.Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
		...
		public BoolQueryDescriptor<T> Filter(params Func<QueryContainerDescriptor<T>, QueryContainer>[] queries) =>
			Assign(a => a.Filter = queries.Select(q => q?.InvokeQuery(new QueryContainerDescriptor<T>())).Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
		...
		public BoolQueryDescriptor<T> Filter(params QueryContainer[] queries) =>
			Assign(a => a.Filter = queries.Where(q => q.WritableAndNotNull()).ToListOrNullIfEmpty());
	}
}
